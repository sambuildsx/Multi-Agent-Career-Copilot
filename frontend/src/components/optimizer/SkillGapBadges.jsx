    ...
    return (
      <div className="glass-panel p-6">
        ...
        <div className="flex items-start gap-3 p-4 rounded-xl bg-slate-800/50 border border-slate-700/50">
          ...
          <div>
            <p className="text-sm font-medium text-slate-300">No Job Description Provided</p>
            <p className="text-sm text-slate-500 mt-1">
              Matched and unmatched skills are only available when a job description is entered. Upload a JD to see how your resume stacks up against the role requirements.
            </p>
          </div>
        </div>
      </div>
